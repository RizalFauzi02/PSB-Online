                ...
                <div class="card">
                    <div class="card-body row g-3">
                        <?php foreach ($detail as $det) : ?>
                            <table>
                                <th>
                                    <a href="<?= base_url('admin/acc/') . $det->id_pendaftaran; ?>" style="text-decoration:none" class="btn btn-gradient-success btn-sm mb-3 float-right" onclick="return confirm('Terima Pendaftaran?')">
                                        <!-- SWEETALERT BUTTON BELUM JALAN -->
                                        <i class="fas fa-trash"></i>Diterima
                                    </a>
                                </th>
                                <th>
                                    <a href="<?= base_url('admin/cad/') . $det->id_pendaftaran; ?>" style="text-decoration:none" class="btn btn-gradient-warning btn-sm mb-3 float-right" onclick="return confirm('Cadangkan Pendaftar?')">
                                        <!-- SWEETALERT BUTTON BELUM JALAN -->
                                        <i class="fas fa-trash"></i>Cadangan
                                    </a>
                                </th>
                                <th>
                                    <a href="<?= base_url('admin/rej/') . $det->id_pendaftaran; ?>" style="text-decoration:none" class="btn btn-gradient-danger btn-sm mb-3 float-right" onclick="return confirm('Tolak Pendaftar?')">
                                        <!-- SWEETALERT BUTTON BELUM JALAN -->
                                        <i class="fas fa-trash"></i>Tidak Diterima
                                    </a>
                                </th>
                            </table>
                        ...
                        <?php endforeach; ?>
                        <div class="col-12">
                            <a href="<?= base_url('Admin/pendaftaran'); ?>" class="btn btn-light float-right btn-sm">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
